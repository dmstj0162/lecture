...
public class SecurityConfig {
    ...
    @Bean
    public SecurityFilterChain filter(HttpSecurity http, UserDetailsService userDetailsService, CorsConfigurationSource corsConfigurationSource) {
        // CSRF 처리
    ...
    @Bean
        public Filter jwtAuthenticationFilter(UserDetailsService userDetailsService) {
