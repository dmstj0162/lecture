...
public class SimpleJPQLRepository {
    ...
    public List<Menu> selectUsingIn() {
        ...
        TypedQuery<Menu> query = entityManager.createQuery(jpql, Menu.class);
        List<Menu> resultCategoryInList = query.getResultList();
        return resultCategoryInList;
    }
    ...
    public List<Menu> selectUsingLike() {
        ...
        TypedQuery<Menu> query = entityManager.createQuery(jpql, Menu.class);
        List<Menu> resultCategoryLikeList = query.getResultList();
        return resultCategoryLikeList;
    }
}
